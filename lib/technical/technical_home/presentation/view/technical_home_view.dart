...
import 'package:splash_app/technical/technical_home/presentation/view/all_orders_view_body.dart';
...
import 'package:splash_app/technical/technical_setting/presentation/views/setting_tecnical_view_body.dart';
...
navBarStyle: NavBarStyle.style10,
      ...
      onItemSelected: (index) {
        if (_controller.index == index) {
          // Refresh the page if the same tab is selected
  ...
  List<Widget> _buildScreens() {
    return [
      ...
      _buildTabScreen(
          _tabNavigatorKeys[1], const ComplateOrderViewBody(), 'Accepted'),
      _buildTabScreen(
    ...
    switch (index) {
      ...
      case 1:
        return _buildScreenWithAppBar(
            const ComplateOrderViewBody(), 'Accepted');
      case 2:
