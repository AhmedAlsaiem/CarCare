...
import 'package:splash_app/feature/technical/technical_home/presentation/widget/oreder_details_in_complate_order.dart';


class OrderInInprogressOrder extends StatefulWidget {
  const OrderInInprogressOrder({
    super.key,
  ...
  @override
  State<OrderInInprogressOrder> createState() => _OrderInInprogressOrderState();
}

class _OrderInInprogressOrderState extends State<OrderInInprogressOrder> {
          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: Container(
                ...
                //   borderRadius: BorderRadius.circular(AppSize.s12),
                // ),
                child: OrederDetailsInInprogressOrder(
